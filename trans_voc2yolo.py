...
voc_root = r"E:\经典神经网络\deep-learning-for-image-processing\pytorch_object_detection\faster_rcnn\VOCdevkit"
voc_version = "VOC2012"
...
def translate_info(file_names: list, save_root: str, class_dict: dict, train_val='train'):
    ...
    for file in tqdm(file_names, desc="translate {} file...".format(train_val)):
        ...
        # copy image into save_images_path。os.sep是路径中的分隔符
